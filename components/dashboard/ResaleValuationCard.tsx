      ...
      <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="w-full lg:w-5/12 space-y-10">
          <div className="space-y-3">
            ...
            <p className="text-blue-400/60 text-[10px] font-black uppercase tracking-[0.2em]">Telemetry-Derived Market Value</p>
          </div>
        ...
        <div className="w-full lg:w-7/12 space-y-8 lg:border-l lg:border-white/10 lg:pl-12">
          <div className="space-y-6">
            <h4 className="text-[9px] font-black text-slate-500 uppercase tracking-widest border-b border-white/5 pb-2">Valuation Adjustments</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-center group/item">
                <div className="space-y-1">
                  ...
                  <div className="text-[8px] text-slate-500 font-black uppercase tracking-widest">Verified Service History Bonus</div>
                </div>
              ...
              <div className="flex justify-between items-center group/item">
                <div className="space-y-1">
                  ...
                  <div className="text-[8px] text-slate-500 font-black uppercase tracking-widest">Unresolved Overdue Components</div>
                </div>
              ...
              {valuation.mechanicalRiskPenalty > 0 && (
                <div className="flex justify-between items-center group/item animate-pulse">
                  <div className="space-y-1">
                    ...
                    <div className="text-[8px] text-slate-500 font-black uppercase tracking-widest">Efficiency Variance Deduction</div>
                  </div>
          ...
          <div className="pt-6 border-t border-white/10">
            <div className="bg-blue-600/10 border border-blue-500/20 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="space-y-1 text-center sm:text-left">
                <div className="text-[8px] font-black text-blue-400 uppercase tracking-widest">Peak Market Potential</div>
              ...
              <p className="text-[8px] font-black text-blue-300 uppercase leading-relaxed max-w-[200px] text-center sm:text-right">
                Unlock full equity by resolving mechanical debt and efficiency leaks.
              </p>
            </div>
          </div>
        </div>
