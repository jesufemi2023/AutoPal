        ...
        <div className="w-full space-y-10 shrink-0">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-[10px] lg:text-[11px] font-black text-slate-500 uppercase tracking-[0.5em]">Market Liquidity</h3>
            </div>
            ...
            <p className="text-blue-500/80 text-[10px] font-black uppercase tracking-[0.3em] font-mono font-bold">Optimized Valuation v5.1</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full">
            <div className="bg-white/5 border border-white/10 rounded-[1.75rem] p-8 backdrop-blur-md group-hover:bg-white/10 transition-all flex flex-col justify-center">
              <div className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2">Market Grade</div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-[1.75rem] p-8 backdrop-blur-md group-hover:bg-white/10 transition-all flex flex-col justify-center">
              <div className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2">Equity Preserved</div>
        ...
        <div className="w-full flex flex-col space-y-8 border-t border-white/10 pt-10">
          <div className="space-y-6">
            <div className="flex justify-between items-center border-b border-white/5 pb-4">
              <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Adjustments Ledger</h4>
              <span className="text-[9px] font-mono text-blue-500 font-bold tracking-widest">NGN UNIT</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-10">
              ...
              <div className="flex justify-between items-center group/item gap-4">
                <div className="space-y-1">
                  <div className="text-base font-bold text-white group-hover/item:text-emerald-400 transition-colors">Integrity</div>
                  <div className="text-[9px] text-slate-500 font-black uppercase tracking-[0.2em]">Verified Data</div>
                </div>
              ...
              <div className="flex justify-between items-center group/item gap-4">
                <div className="space-y-1">
                  <div className="text-base font-bold text-white group-hover/item:text-rose-400 transition-colors">Technical Debt</div>
                  <div className="text-[9px] text-slate-500 font-black uppercase tracking-[0.2em]">Overdue Tasks</div>
                </div>
              ...
              {valuation.mechanicalRiskPenalty > 0 && (
                <div className="flex justify-between items-center group/item gap-4">
                  <div className="space-y-1">
                    <div className="text-base font-bold text-amber-500">Variance</div>
                    <div className="text-[9px] text-slate-500 font-black uppercase tracking-[0.2em]">Efficiency Drift</div>
                  </div>
              ...
              <div className="flex justify-between items-center group/item gap-4">
                <div className="space-y-1">
                  <div className="text-base font-bold text-white whitespace-nowrap">Usage Correction</div>
                  <div className="text-[9px] text-slate-500 font-black uppercase tracking-[0.2em]">Mileage Drift</div>
                </div>
          ...
          <div className="pt-4">
            <div className="bg-blue-600/10 border border-blue-500/20 rounded-[1.75rem] p-8 flex flex-col md:flex-row items-center justify-between gap-6 transition-all hover:bg-blue-600/20">
              <div className="space-y-2 text-center md:text-left shrink-0">
                <div className="text-[10px] font-black text-blue-400 uppercase tracking-[0.4em]">Potential Ceiling</div>
              ...
              <p className="text-[9px] font-black text-blue-300 uppercase leading-relaxed md:max-w-[200px] text-center md:text-right tracking-[0.15em] opacity-80">
                Resolve Technical Debt to hit peak equity value.
              </p>
            </div>
          </div>
        </div>
