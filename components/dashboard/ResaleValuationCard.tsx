...
export const ResaleValuationCard: React.FC<{
  ...
  const handleAiAnalysis = async () => {
    ...
    try {
      ...
      console.error(e);
      alert("Neural Intelligence Sync Error. Please check your connection.");
    } finally {
            ...
            <div className="bg-white/5 border border-white/10 rounded-[2rem] p-6 sm:p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                <div className="space-y-2 group/met">
                  <div className="text-[8px] font-black text-slate-500 uppercase tracking-widest group-hover/met:text-blue-400 transition-colors">Efficiency Performance</div>
