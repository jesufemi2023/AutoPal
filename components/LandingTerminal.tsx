    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 w-full overflow-x-hidden">
        ...
        <div className="space-y-10">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 rounded-full border border-blue-100">
              ...
              <span className="text-[9px] font-black text-blue-600 uppercase tracking-widest">Nigeria's #1 Car Assistant</span>
            </div>
            ...
            <p className="text-slate-500 text-lg sm:text-xl font-medium max-w-lg leading-relaxed pt-4">
              Advanced vehicle tracking and help. Automate your service schedule, track every Naira, and maximize resale profit with Autopal.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 pt-12 border-t border-slate-100">
            <div className="space-y-1">
              ...
              <div className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Active Users</div>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <div className="text-[9px] font-black uppercase text-slate-400 tracking-widest">User Satisfaction</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative group hidden lg:block">
          ...
          <div className="bg-slate-950 rounded-[3rem] p-10 text-white space-y-10 shadow-4xl relative border border-white/10">
             <div className="flex justify-between items-start">
               <div className="space-y-1">
                 <h4 className="text-blue-400 text-[10px] font-black uppercase tracking-[0.3em]">Vehicle Scan</h4>
             ...
             <div className="grid grid-cols-2 gap-6">
               <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                 <div className="text-[8px] font-black text-slate-500 uppercase tracking-widest mb-2">Condition Score</div>
      ...
      <section id="trial" className="bg-slate-50 py-24 sm:py-32">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-12 sm:space-y-16">
          <div className="space-y-4">
            ...
            <p className="text-slate-500 text-base sm:text-lg font-medium uppercase tracking-widest">Get a one-time maintenance report with Autopal.</p>
          </div>
      ...
      <section className="py-24 sm:py-32 max-w-7xl mx-auto px-6 sm:px-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-16">
        <div className="space-y-6">
          ...
          <h3 className="text-xl font-black uppercase tracking-tight text-slate-900">Record Trail</h3>
          <p className="text-slate-500 text-sm font-medium leading-relaxed">Digital history that proves your car's condition to future buyers, commanding higher resale prices.</p>
        </div>
        <div className="space-y-6">
          <div className="w-16 h-16 bg-emerald-50 rounded-2xl flex items-center justify-center text-emerald-600 shadow-sm">
            <Zap size={28} />
          </div>
          <h3 className="text-xl font-black uppercase tracking-tight text-slate-900">Autopal Predictor</h3>
          <p className="text-slate-500 text-sm font-medium leading-relaxed">Our system predicts exactly when parts will reach their limit, preventing expensive emergency repairs.</p>
        </div>
        <div className="space-y-6">
          ...
          <p className="text-slate-500 text-sm font-medium leading-relaxed">Advanced tracking detects hidden engine issues through fuel consumption analysis.</p>
        </div>
        <div className="space-y-6">
          ...
          <p className="text-slate-500 text-sm font-medium leading-relaxed">Real-time valuation based on Nigerian market benchmarks and maintenance trust levels.</p>
        </div>
      </section>
