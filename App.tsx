...
const App: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="glass-card card-radius p-8 max-w-sm w-full text-center border-rose-100">
          <h2 className="text-xl font-black mb-2 text-rose-600">Sync Interrupted</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-50 md:flex overflow-x-hidden">
      {/* Sidebar: Visible on MD and above (Tablet/Laptop) */}
        ...
        <div className="pt-8 border-t border-slate-50 space-y-4">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="overflow-hidden">
              ...
              <button onClick={() => supabase?.auth.signOut()} className="text-[9px] font-black uppercase tracking-widest text-slate-400 hover:text-rose-500 transition-colors">Logout Account</button>
            </div>
          </div>
        </div>
      </aside>
